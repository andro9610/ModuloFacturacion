...
public class PanelGestionProductos {

    panelMaker panelGesionProductos;

    /** Elementos del formulario */
    inputMaker campoBusqueda;
    tableMaker creadorTablas;
    buttonMaker botonagregarProducto;
    ...
    private void crear() {
        ...
        panelGesionProductos = new panelMaker(
        ...
        panelGesionProductos.add(campoBusqueda);
        panelGesionProductos.add(
            new labelMaker(
        ...
        panelGesionProductos.add(tablaResultados);
        panelGesionProductos.add(botonagregarProducto);
        addController(creadorTablas);
        panelGesionProductos.updateUI();
    }

    public panelMaker getPanel() {
        if (panelGesionProductos == null) {
            crear();
        }
        return panelGesionProductos;
    }

    protected void addController(tableMaker creadorTablas) {
        GestionProductosController buttonAction =  new GestionProductosController();
