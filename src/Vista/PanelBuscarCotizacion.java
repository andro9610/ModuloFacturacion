...
import Controlador.BuscarCotizacionController;
...
public class PanelBuscarCotizacion {
    ...
    private void crear() {
        ...
        panelBuscarCotizacion = new panelMaker(
        ...
        panelBuscarCotizacion.add(
            new labelMaker(
                "BUSQUEDA DE COTIZACIONES",
                (int) (anchoPanel * 0.02767),(int) (altoPanel * 0.0355),
                (int) (anchoPanel * 0.375), (int) (altoPanel * 0.04444),
        ...
        panelBuscarCotizacion.add(campoBusqueda);
        panelBuscarCotizacion.add(
            new labelMaker(
        ...
        panelBuscarCotizacion.add(tablaResultados);
        addController(creadorTablas);
        panelBuscarCotizacion.updateUI();
    }

    public panelMaker getPanel() {
        if (panelBuscarCotizacion == null) {
            crear();
        }
        return panelBuscarCotizacion;
    }

    protected void addController(tableMaker creadorTablas) {
        BuscarCotizacionController buttonAction =  new BuscarCotizacionController();
